...
/*   Updated: 2023/08/07 14:20:59 by arabelo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// This function uses the opposite_direction_a_1
// as well as the opposite_direction_a_2 functions
	...
	t_list **head_dest, char position_type)
{
	...
	dest_rotations = right_position_at_dest(cheapest, *head_dest,
			position_type);
	opposite_direction_a_1(head_origin, head_dest,
		&origin_rotations, &dest_rotations);
	opposite_direction_a_2(head_origin, head_dest,
		&origin_rotations, &dest_rotations);
}
